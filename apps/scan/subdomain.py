...
def remove_duplicates(target_name,scan_name):
    ...
    file = os.path.join(dir,r"scans_folder",target_name,scan_name,r"subdomain/subdomain_output.txt")
    openFile = open(file, "r")
    file3=os.path.join(dir,r"scans_folder",target_name,scan_name,r"subdomain/clean_subdomain_output.txt")
